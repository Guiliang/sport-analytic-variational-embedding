...
if __name__ == '__main__':
    ...
    save_calibration_dir = './calibration_results/calibration_lstm_diff_[]_2019September30_model2101.txt'
    # save_calibration_dir = './calibration_results/calibration_cvrnn_[]_2019September30_box.txt'
    #
